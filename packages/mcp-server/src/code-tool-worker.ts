...
const fuse = new Fuse(
  [
    ...
    'client.contextDocuments.generate',
    'client.contextDocuments.get',
    'client.contextDocuments.list',
    'client.contextDocuments.trees.generate',
    'client.contextDocuments.trees.get',
    'client.contextDocuments.trees.getLatest',
    'client.contextDocuments.trees.progress',
    'client.contextDocuments.digests.generate',
    'client.contextDocuments.digests.list',
    'client.contextDocuments.config.get',
    'client.contextDocuments.config.reset',
    'client.contextDocuments.config.update',
    'client.memories.add',
