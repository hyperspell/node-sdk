...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.entities.search',
    fullyQualifiedName: 'entities.search',
    httpMethod: 'post',
    httpPath: '/entities/search',
  },
  {
    clientCallName: 'client.live.listSources',
    fullyQualifiedName: 'live.listSources',
    httpMethod: 'get',
    httpPath: '/live/sources',
  },
  {
    clientCallName: 'client.live.listResources',
    fullyQualifiedName: 'live.listResources',
    httpMethod: 'get',
    httpPath: '/live/{source}/resources',
  },
  {
    clientCallName: 'client.live.getResource',
    fullyQualifiedName: 'live.getResource',
    httpMethod: 'get',
    httpPath: '/live/{source}/resources/{resource_id}',
  },
  {
    clientCallName: 'client.live.search',
    fullyQualifiedName: 'live.search',
    httpMethod: 'post',
    httpPath: '/live/{source}/search',
  },
  {
