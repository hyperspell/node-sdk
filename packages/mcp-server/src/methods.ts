...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.contextDocuments.generate',
    fullyQualifiedName: 'contextDocuments.generate',
    httpMethod: 'post',
    httpPath: '/context-documents/generate',
  },
  {
    clientCallName: 'client.contextDocuments.list',
    fullyQualifiedName: 'contextDocuments.list',
    httpMethod: 'get',
    httpPath: '/context-documents',
  },
  {
    clientCallName: 'client.contextDocuments.get',
    fullyQualifiedName: 'contextDocuments.get',
    httpMethod: 'get',
    httpPath: '/context-documents/{document_id}',
  },
  {
    clientCallName: 'client.contextDocuments.trees.generate',
    fullyQualifiedName: 'contextDocuments.trees.generate',
    httpMethod: 'post',
    httpPath: '/context-documents/tree',
  },
  {
    clientCallName: 'client.contextDocuments.trees.getLatest',
    fullyQualifiedName: 'contextDocuments.trees.getLatest',
    httpMethod: 'get',
    httpPath: '/context-documents/tree/latest',
  },
  {
    clientCallName: 'client.contextDocuments.trees.get',
    fullyQualifiedName: 'contextDocuments.trees.get',
    httpMethod: 'get',
    httpPath: '/context-documents/tree/by-id/{tree_id}',
  },
  {
    clientCallName: 'client.contextDocuments.trees.progress',
    fullyQualifiedName: 'contextDocuments.trees.progress',
    httpMethod: 'get',
    httpPath: '/context-documents/tree/{tree_id}/progress',
  },
  {
    clientCallName: 'client.contextDocuments.digests.generate',
    fullyQualifiedName: 'contextDocuments.digests.generate',
    httpMethod: 'post',
    httpPath: '/context-documents/digest',
  },
  {
    clientCallName: 'client.contextDocuments.digests.list',
    fullyQualifiedName: 'contextDocuments.digests.list',
    httpMethod: 'get',
    httpPath: '/context-documents/digest/list',
  },
  {
    clientCallName: 'client.contextDocuments.config.get',
    fullyQualifiedName: 'contextDocuments.config.get',
    httpMethod: 'get',
    httpPath: '/context-documents/config',
  },
  {
    clientCallName: 'client.contextDocuments.config.update',
    fullyQualifiedName: 'contextDocuments.config.update',
    httpMethod: 'patch',
    httpPath: '/context-documents/config',
  },
  {
    clientCallName: 'client.contextDocuments.config.reset',
    fullyQualifiedName: 'contextDocuments.config.reset',
    httpMethod: 'post',
    httpPath: '/context-documents/config/reset',
  },
  {
