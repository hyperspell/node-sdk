...
export const handler = async (client: Hyperspell, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.documents.get(source, resource_id)));
};
