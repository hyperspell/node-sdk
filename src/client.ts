...
export interface ClientOptions {
   ...
   * Set the log level.
   *
   * Defaults to process.env['HYPERSPELL_LOG'] or 'warn' if it isn't set.
   */
...
export class Hyperspell {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Hyperspell.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('HYPERSPELL_LOG'), "process.env['HYPERSPELL_LOG']", this) ??
      defaultLogLevel;
  ...
  >(
    ...
    return new Pagination.PagePromise<PageClass, Item>(this as any as Hyperspell, request, Page);
  }
